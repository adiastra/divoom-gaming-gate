...
from PyQt5.QtWidgets import (
    ...
    QFileDialog, QSpinBox, QSlider, QComboBox, QGroupBox, QSizePolicy
)
...
class ScreenControl(QWidget):
    def __init__(self, screen_index):
        ...
        # Raw PIL frames and processed frames
        self.raw_frames = []
        self.frames = []
    ...
    def apply_mode(self):
        """Process raw_frames according to current mode into self.frames, then preview."""
        ...
        def normalize(img):
            ...
            if mode == "Stretch":
                ...
                return cropped.resize((IMG_SIZE, IMG_SIZE), Image.LANCZOS)
            # default fallback
            return img.resize((IMG_SIZE, IMG_SIZE), Image.LANCZOS)
